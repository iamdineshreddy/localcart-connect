            ...
            <div key={item.id} className="bg-card rounded-xl border overflow-hidden">
              ...
              <div className="p-3">
                ...
                <div className="flex gap-2 mt-2">
                  <Button size="sm" className="flex-1 text-xs" onClick={() => addToCart.mutate({ productId: item.product?.id || '' })}>
                    <ShoppingCart className="w-3 h-3 mr-1" /> Add
                  </Button>
                  <Button size="sm" variant="outline" onClick={() => removeFromWishlist.mutate(item.id)}>
